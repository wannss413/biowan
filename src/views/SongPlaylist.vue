...
const songs = [
  {
    ...
    artist: 'James Arthur',
    url: 'public/music/Anne-Marie & James Arthur - Rewrite The Stars [from The Greatest Showman_ Reimagined] [pRfmrE0ToTo].mp3',
    cover: 'public/image/jamesa.jpg',
  },
  {
    id: 2,
    title: 'Night Changes',
    artist: 'One Direction',
    url: 'public/music/One Direction - Night Changes [syFZfO_wfMQ].mp3',
    cover: 'public/image/night.jpg',
  },
  {
    id: 3,
    title: 'A Thousand Years',
    artist: 'Christina Perri',
    url: 'public/music/Christina Perri - A Thousand Years [Official Music Video] [rtOvBOTyX00].mp3',
    cover: 'public/image/cristianna.png',
  },
  {
    id: 4,
    title: 'Until I Found You',
    artist: 'Stephen Sanchez',
    url: 'public/music/Stephen Sanchez - Until I Found You (Official Video) [GxldQ9eX2wo].mp3',
    cover: 'public/image/until.jpg',
  },
  {
    id: 5,
    title: 'End Of Beginning',
    artist: 'Djo',
    url: 'public/music/Djo - End Of Beginning (Lyrics) [B3Z4XGAxJB0].mp3',
    cover: 'public/image/end.jpg ',
  },
  {
    id: 6,
    title: 'Photograph',
    artist: 'Ed Sheeran',
    url: 'public/music/Ed Sheeran - Photograph (Lyrics) [HpphFd_mzXE].mp3',
    cover: 'public/image/photo.jpg',
  },
]
